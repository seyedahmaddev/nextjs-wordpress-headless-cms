    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-5xl px-4 lg:px-2">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl whitespace-nowrap">
            از ایده تا محصول نهایی، با تکنولوژی‌های روز
          </p>
          <p className="mt-6 text-lg/8 text-gray-700 whitespace-nowrap">
