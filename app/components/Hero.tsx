    ...
    return (
        <div className="bg-white">
            <div className="relative isolate overflow-hidden bg-linear-to-b from-indigo-100/20 ">
                ...
                />
                <div className="mx-auto max-w-7xl px-6 py-4 lg:py-40 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                        <h1 className="max-w-2xl text-2xl font-semibold tracking-tight text-balance text-gray-900 sm:text-3xl lg:col-span-2 xl:col-auto">
                          طراحی سایت حرفه‌ای و فروشگاهی با React، Next.js و وردپرس Headless
                        </h1>
                        <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                            ...
                            <div className="mt-10 flex items-center justify-center lg:justify-start gap-x-6">
                                ...
                                <Link href="#Techs" className="text-sm/6 font-semibold text-gray-900">
                                   مشاهده خدمات<span aria-hidden="true">←</span>
                                </Link>
                            </div>
                        </div>
                        <img
